...
@interface LLMenuView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_menuCollectionView registerClass:[LLMenuCell class] forCellWithReuseIdentifier:TMenuCell_ReuseId];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row % 2 == 0){
        LLMenuCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMenuCell_ReuseId forIndexPath:indexPath];
        ...
        cell.backgroundColor = TMenuView_Line_Color;
        return cell;
    }
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row % 2 == 0){
        ...
        return CGSizeMake(TMenuView_Line_Width, collectionView.frame.size.height);
    }
}
