...
static LLInputMoreCellData *TUI_Photo_MoreCell;
static LLInputMoreCellData *TUI_Picture_MoreCell;
static LLInputMoreCellData *TUI_Video_MoreCell;
static LLInputMoreCellData *TUI_File_MoreCell;

@implementation LLInputMoreCellData



+ (LLInputMoreCellData *)pictureData
{
    if (!TUI_Picture_MoreCell) {
        TUI_Picture_MoreCell = [[LLInputMoreCellData alloc] init];
...
+ (void)setPictureData:(LLInputMoreCellData *)cameraData
{
    TUI_Picture_MoreCell = cameraData;
}

+ (LLInputMoreCellData *)photoData
{
    if (!TUI_Photo_MoreCell) {
        TUI_Photo_MoreCell = [[LLInputMoreCellData alloc] init];
...
+ (void)setPhotoData:(LLInputMoreCellData *)pictureData
{
    TUI_Photo_MoreCell = pictureData;
}

+ (LLInputMoreCellData *)videoData
{
    if (!TUI_Video_MoreCell) {
        TUI_Video_MoreCell = [[LLInputMoreCellData alloc] init];
...
+ (void)setVideoData:(LLInputMoreCellData *)videoData
{
    TUI_Video_MoreCell = videoData;
}

+ (LLInputMoreCellData *)fileData
{
    if (!TUI_File_MoreCell) {
        TUI_File_MoreCell = [[LLInputMoreCellData alloc] init];
...
+ (void)setFileData:(LLInputMoreCellData *)fileData
{
...
@implementation LLInputMoreCell
